...
namespace CareAlz.Controllers
{
    public class MunicipalitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MunicipalityId,Description,StateId")] Municipality municipality)
        {
            ...
            ViewBag.StateId = new SelectList(db.States, "StateId", "Description", municipality.StateId);
            return View(municipality);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MunicipalityId,Description,StateId")] Municipality municipality)
        {
            if (ModelState.IsValid)
            {
